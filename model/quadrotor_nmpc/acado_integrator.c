...
out[6] = (((((a[10]*a[11])*a[12])+(a[13]*a[14]))*u[3])/(real_t)(1.5200000000000000e+00));
out[7] = (((((a[15]*a[16])*a[17])-(a[18]*a[19]))*u[3])/(real_t)(1.5200000000000000e+00));
out[8] = ((((a[20]*a[21])*u[3])/(real_t)(1.5200000000000000e+00))-(real_t)(9.8100000000000005e+00));
out[9] = ((u[0]-((((real_t)(9.7699999999999995e-02)*xd[11])*xd[10])-(((real_t)(4.5892900000000000e-02)*xd[10])*xd[11])))/(real_t)(3.4756299999999997e-02));
out[10] = ((u[1]-((((real_t)(3.4756299999999997e-02)*xd[9])*xd[11])-(((real_t)(9.7699999999999995e-02)*xd[11])*xd[9])))/(real_t)(4.5892900000000000e-02));
out[11] = ((u[2]-((((real_t)(4.5892900000000000e-02)*xd[9])*xd[10])-(((real_t)(3.4756299999999997e-02)*xd[9])*xd[10])))/(real_t)(9.7699999999999995e-02));
}
...
a[27] = (sin(xd[5]));
a[28] = (cos(xd[3]));
a[29] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.5200000000000000e+00));
a[30] = (cos(xd[4]));
a[31] = (cos(xd[3]));
a[32] = ((real_t)(-1.0000000000000000e+00)*(sin(xd[5])));
a[33] = (cos(xd[5]));
a[34] = (sin(xd[3]));
a[35] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.5200000000000000e+00));
a[36] = (sin(xd[5]));
a[37] = (sin(xd[4]));
a[38] = ((real_t)(-1.0000000000000000e+00)*(sin(xd[3])));
a[39] = (cos(xd[5]));
a[40] = (cos(xd[3]));
a[41] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.5200000000000000e+00));
a[42] = (cos(xd[4]));
a[43] = (cos(xd[3]));
a[44] = (cos(xd[5]));
a[45] = ((real_t)(-1.0000000000000000e+00)*(sin(xd[5])));
a[46] = (sin(xd[3]));
a[47] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.5200000000000000e+00));
a[48] = (cos(xd[4]));
a[49] = ((real_t)(-1.0000000000000000e+00)*(sin(xd[3])));
a[50] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.5200000000000000e+00));
a[51] = ((real_t)(-1.0000000000000000e+00)*(sin(xd[4])));
a[52] = (cos(xd[3]));
a[53] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.5200000000000000e+00));
a[54] = ((real_t)(1.0000000000000000e+00)/(real_t)(3.4756299999999997e-02));
a[55] = ((real_t)(1.0000000000000000e+00)/(real_t)(3.4756299999999997e-02));
a[56] = ((real_t)(1.0000000000000000e+00)/(real_t)(4.5892900000000000e-02));
a[57] = ((real_t)(1.0000000000000000e+00)/(real_t)(4.5892900000000000e-02));
a[58] = ((real_t)(1.0000000000000000e+00)/(real_t)(9.7699999999999995e-02));
a[59] = ((real_t)(1.0000000000000000e+00)/(real_t)(9.7699999999999995e-02));
...
out[99] = (((((a[24]*a[25])*a[26])+(a[27]*a[28]))*u[3])*a[29]);
out[100] = ((((a[24]*a[30])*a[31])*u[3])*a[29]);
out[101] = (((((a[32]*a[25])*a[31])+(a[33]*a[34]))*u[3])*a[29]);
...
out[111] = ((((a[24]*a[25])*a[31])+(a[27]*a[34]))*a[35]);
out[112] = (real_t)(0.0000000000000000e+00);
out[113] = (real_t)(0.0000000000000000e+00);
out[114] = (real_t)(0.0000000000000000e+00);
out[115] = (((((a[36]*a[37])*a[38])-(a[39]*a[40]))*u[3])*a[41]);
out[116] = ((((a[36]*a[42])*a[43])*u[3])*a[41]);
out[117] = (((((a[44]*a[37])*a[43])-(a[45]*a[46]))*u[3])*a[41]);
...
out[154] = (((real_t)(0.0000000000000000e+00)-(((real_t)(9.7699999999999995e-02)*xd[11])-((real_t)(4.5892900000000000e-02)*xd[11])))*a[54]);
out[155] = (((real_t)(0.0000000000000000e+00)-(((real_t)(9.7699999999999995e-02)*xd[10])-((real_t)(4.5892900000000000e-02)*xd[10])))*a[54]);
out[156] = a[55];
...
out[169] = (((real_t)(0.0000000000000000e+00)-(((real_t)(3.4756299999999997e-02)*xd[11])-((real_t)(9.7699999999999995e-02)*xd[11])))*a[56]);
out[170] = (real_t)(0.0000000000000000e+00);
out[171] = (((real_t)(0.0000000000000000e+00)-(((real_t)(3.4756299999999997e-02)*xd[9])-((real_t)(9.7699999999999995e-02)*xd[9])))*a[56]);
...
out[185] = (((real_t)(0.0000000000000000e+00)-(((real_t)(4.5892900000000000e-02)*xd[10])-((real_t)(3.4756299999999997e-02)*xd[10])))*a[58]);
out[186] = (((real_t)(0.0000000000000000e+00)-(((real_t)(4.5892900000000000e-02)*xd[9])-((real_t)(3.4756299999999997e-02)*xd[9])))*a[58]);
...
rk_diffsNew2[(i * 16) + (run1)] += + rk_diffK[i * 2]*(real_t)5.0000000000000001e-03 + rk_diffK[i * 2 + 1]*(real_t)5.0000000000000001e-03;
}
}
...
for (i = 0; i < 12; ++i)
{
rk_diffsNew2[(i * 16) + (run1 + 12)] = + rk_diffK[i * 2]*(real_t)5.0000000000000001e-03 + rk_diffK[i * 2 + 1]*(real_t)5.0000000000000001e-03;
}
}
...
rk_eta[4] += + rk_kkk[8]*(real_t)5.0000000000000001e-03 + rk_kkk[9]*(real_t)5.0000000000000001e-03;
rk_eta[5] += + rk_kkk[10]*(real_t)5.0000000000000001e-03 + rk_kkk[11]*(real_t)5.0000000000000001e-03;
rk_eta[6] += + rk_kkk[12]*(real_t)5.0000000000000001e-03 + rk_kkk[13]*(real_t)5.0000000000000001e-03;
rk_eta[7] += + rk_kkk[14]*(real_t)5.0000000000000001e-03 + rk_kkk[15]*(real_t)5.0000000000000001e-03;
rk_eta[8] += + rk_kkk[16]*(real_t)5.0000000000000001e-03 + rk_kkk[17]*(real_t)5.0000000000000001e-03;
rk_eta[9] += + rk_kkk[18]*(real_t)5.0000000000000001e-03 + rk_kkk[19]*(real_t)5.0000000000000001e-03;
rk_eta[10] += + rk_kkk[20]*(real_t)5.0000000000000001e-03 + rk_kkk[21]*(real_t)5.0000000000000001e-03;
rk_eta[11] += + rk_kkk[22]*(real_t)5.0000000000000001e-03 + rk_kkk[23]*(real_t)5.0000000000000001e-03;
for (i = 0; i < 12; ++i)
{
for (j = 0; j < 12; ++j)
{
