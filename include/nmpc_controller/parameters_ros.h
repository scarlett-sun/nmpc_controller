#ifndef INCLUDE_NMPC_CONTROLLER_PARAMETERS_ROS_H_
#define INCLUDE_NMPC_CONTROLLER_PARAMETERS_ROS_H_

#include <ros/ros.h>

#include "nmpc_controller/parameters.h"
...
#endif /* INCLUDE_NMPC_CONTROLLER_PARAMETERS_ROS_H_ */
